...
function getLocalizedEmailCopy(inputLanguage) {
  ...
  const localized = {
    traditionalChinese: { lang: "zh-Hant", title: "你的 Recycled Trash Talk 已準備好！", intro: "這是你剛剛創作的獨一無二設計。你可以下載、保存，也可以自由分享給任何人。", productsTitle: "想把它做成實物嗎？", productsIntro: "下面是你的設計放在產品上的效果。準備好時，使用下方按鈕訂購這個設計。", cta: "立即訂購", footer: "此信箱不作回覆，但你可以隨時使用訂購按鈕購買。" },
    simplifiedChinese: { lang: "zh-Hans", title: "你的 Recycled Trash Talk 已准备好！", intro: "这是你刚刚创作的独一无二设计。你可以下载、保存，也可以自由分享给任何人。", productsTitle: "想把它做成实物吗？", productsIntro: "下面是你的设计放在产品上的效果。准备好时，使用下方按钮订购这个设计。", cta: "立即订购", footer: "此邮箱不作回复，但你可以随时使用订购按钮购买。" },
    japanese: { lang: "ja", title: "あなたの Recycled Trash Talk が完成しました！", intro: "これは、あなたが作った世界にひとつだけのデザインです。ダウンロードして保存し、自由にシェアできます。", productsTitle: "実物アイテムにしてみますか？", productsIntro: "あなたのデザインを商品に載せたイメージです。注文したくなったら、下のボタンからこのデザインを注文できます。", cta: "今すぐ注文", footer: "このメールボックスは返信を確認していません。購入したい時は注文ボタンを使ってください。" },
    korean: { lang: "ko", title: "당신의 Recycled Trash Talk 디자인이 준비됐어요!", intro: "방금 만든 단 하나뿐인 디자인입니다. 다운로드하고 보관하고 자유롭게 공유할 수 있어요.", productsTitle: "실물 상품으로 만들어볼까요?", productsIntro: "아래는 당신의 디자인을 상품에 올린 모습입니다. 준비되면 아래 버튼으로 이 디자인을 주문할 수 있습니다.", cta: "지금 주문", footer: "이 메일함은 모니터링되지 않습니다. 구매할 준비가 되면 주문 버튼을 사용해 주세요." },
  };
